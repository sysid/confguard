...
The simplest way to install confguard is using Pip.

.. code-block:: console

    $ pip install confguard

This will install ``confguard`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/sysid/confguard/issues>`_.
